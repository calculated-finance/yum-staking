...
abstract contract ERC20Vote {
    ...
    function delegates(
        address delegator
    ) public view virtual returns (address delegatee) {
    ...
    function getCurrentVotes(
        address account
    ) public view virtual returns (uint256 votes) {
    ...
    function getPriorVotes(
        address account,
        uint256 timestamp
    ) public view virtual returns (uint96 votes) {
    ...
    function _writeCheckpoint(
        ...
        unchecked {
            ...
            if (
                ...
                checkpoints[delegatee][nCheckpoints - 1].votes = safeCastTo96(
                    newVotes
                );
            } else {
