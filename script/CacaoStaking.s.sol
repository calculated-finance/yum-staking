...
contract DeployStakingContract is Script {
  ...
  function run() external {
    uint256 cooldownPeriod = 3 minutes;
    ...
    staking = new YUMStaking(IERC20(address(mockToken)), account, cooldownPeriod);
...
// forge script script/YUMStakingDeploy.s.sol --fork-url http://localhost:8545
